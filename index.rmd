...
subtitle: "A showcase of how data science can help to drive digital healthcare"
author:
institute:
date: "<br><br><br><br><br><br>Dr. Chris Gaskell<br>Clinical Psychologist<br>2021/19/12 (last updated: `r Sys.Date()`)"
output:
...
.small[R has loads of functions built in.
...
time to go back and repeat steps? limited functionality and flexibility?
...
- Write the results the data is being analysed then hit run the report. If the data changes then the report will change too.
...
- products, resources, worksheets, teaching slides that people *actually* want to use.
...
.pull-left[
`r embed_youtube("Dy3XLo7dVQI", width = 400, height = 450) %>% use_start_time("0m04s")`
]
...
background-size: 470px 350px, 470px 350px
...
.pull-left[
- Lightweight (embed videos, gifs, large images).
- No need to send files - host online. www.r-for-cp.netlify.app
