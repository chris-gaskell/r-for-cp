...
- Write the results as the data is being analysed then hit run the report. If the data changes then the report will change too.
...
- No need to send files - host online.<br>
<a href="www.r-for-cp.netlify.app">www.r-for-cp.netlify.app</a>


<a href="http://fnd-for-paramedics.netlify.app">Some clinical teaching I have delivered about dissociative seizures.</a>

<a href="http://chris-gaskell.github.io/uos-sced/day-one/index.html">Some academic teaching I have delivered about on conducting practice based research</a>
]
...
.pull-left[
- Books that are polished, professional and interactive.
- Able to output to html, msword or pdf.
- Protocols and treatment manuals.
- Patient resources.
